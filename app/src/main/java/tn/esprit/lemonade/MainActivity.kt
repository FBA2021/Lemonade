...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (count) {
            1 -> textAction.setText(R.string.lemon_squeeze)
            2 -> textAction.setText (R.string.lemon_drink)
            3 -> textAction.setText (R.string.lemon_empty_glass)
            else -> textAction.setText(R.string.lemon_select)
        }
    }
